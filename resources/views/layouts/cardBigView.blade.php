        ...
        @foreach ($data as $anime)
            ...
            <div class="container mx-auto md:mx-auto rounded-lg bg-gray-800 shadow md:shadow-2xl"
                ...
                <div class="relative z-30">
                    @if ($anime->Poster)
                        <img class="w-full" src="{{$anime->Poster}}"
                             style="float: left;object-fit: cover;height: 500px;">
                    @else
                ...
                <div class="pt-9 pb-8 text-center">
                        ...
                        <span
                            class="bg-clip-text md:text-2xl text-white bg-gradient-to-r ">{{str_replace("%20", " ", $anime->Name)}}</span>
                </div>
                <div class="text-center">
      <span
          class="mb-auto my-4 md:text-1xl font-bold leading-tight text-center bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500"
          ...
          {{$anime->Seasons}}
                ...
                <div
                    class="m-4 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500 mt-auto"
                ...
                <div class="beschreibung mt-auto p-2"
                     style="border-width: thin; border-color: #2d3748; min-height: 170px"> Beschreibung: <br>
                    {{$anime->Plot}}
                </div>
